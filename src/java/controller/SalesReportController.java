...
@WebServlet(name = "SalesReportController", urlPatterns = {"/SalesReport1"})
public class SalesReportController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "view":
                // Lấy dữ liệu báo cáo
                List<Order1> orders = daoSales.getOrdersByDate(reportDate);
                ...
                request.getRequestDispatcher("SalesReport1.jsp").forward(request, response);
                break;
            ...
            default:
                response.sendRedirect("SalesReport1");
                break;
        }
    }
