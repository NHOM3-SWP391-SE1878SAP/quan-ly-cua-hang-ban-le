...
public Integer getPaymentIdByMethod(String paymentMethod) {
    Integer paymentID = null;
    String sql = "SELECT ID FROM Payments WHERE PaymentMethods = ?";
    ...
    try (PreparedStatement pst = conn.prepareStatement(sql)) {
        ...
        LOGGER.log(Level.SEVERE, "Error fetching payment method by name", e);
    }
