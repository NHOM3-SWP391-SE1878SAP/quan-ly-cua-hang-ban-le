                    ...
                    <div class="col-md-2 mb-2">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<c:url value='/order'/>" method="get" id="searchForm">
                                    <div class="mb-3">
                            ...
                            <div class="card-body p-3">
                                            ...
                                            <c:forEach items="${orders}" var="order">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${order.orderType eq 'SALE'}">
                                                                <a href="order?action=viewDetails&type=SALE&id=${order.id}" class="btn btn-sm btn-primary">
                                                                    <i class="bi bi-eye"></i>
                                                                </a>
                                                            </c:when>
                                                            <c:when test="${order.orderType eq 'RETURN'}">
                                                                <a href="order?action=viewDetails&type=RETURN&id=${order.id}" class="btn btn-sm btn-primary">
                                                                    <i class="bi bi-eye"></i>
                                                                </a>
                                                            </c:when>
                                                        </c:choose>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div class="pagination-controls">
                                        <!-- First page button -->
                                        <a href="<c:url value='/order?page=1${searchParams}'/>" class="btn btn-sm btn-outline-secondary">
                                        ...
                                        <a href="<c:url value='/order?page=${prevPage}${searchParams}'/>" class="btn btn-sm btn-outline-secondary me-1">
                                        ...
                                        <c:choose>
                                            <c:when test="${totalPages <= 5}">
                                                ...
                                                <c:forEach begin="1" end="${totalPages}" var="i">
                                                    <a href="<c:url value='/order?page=${i}${searchParams}'/>" 
                                        ...
                                        <a href="<c:url value='/order?page=${nextPage}${searchParams}'/>" class="btn btn-sm btn-outline-secondary me-1">
                                            <i class="bi bi-chevron-right"></i>
                                        </a>

                                        <!-- Last page button -->
                                        <a href="<c:url value='/order?page=${totalPages}${searchParams}'/>" class="btn btn-sm btn-outline-secondary">
