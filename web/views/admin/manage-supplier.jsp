...
<html lang="en">
    ...
    <body>
        ...
        <jsp:include page="../../common/header-admin.jsp"></jsp:include>
            <!-- End Header -->
        <jsp:include page="../../common/silde-bar-admin.jsp"></jsp:include>
            ...
            <!-- Add Supplier Modal -->
        <jsp:include page="../../modal/modal-add-supplier.jsp"></jsp:include>
        <!-- End Add Supplier Modal -->

        <!-- Import Supplier Modal -->
        <jsp:include page="../../modal/model-import-supplier.jsp"></jsp:include>
        <!-- End Import Supplier Modal -->

        <!-- Add Group Modal -->
        <jsp:include page="../../modal/add-group-modal.jsp"></jsp:include>
        <!-- End Add Group Modal -->
